;(function(){
	...
	function SPEED_X(){return 2 + RND() * 2}
	function SPEED_Y(){return 1 + RND() * 1.2}
	...
	CreateBubble = function(obj) {
		...
		var bub = new Bubble(obj);

		var w = Math.random() * document.body.clientWidth;
		var h = Math.random() * document.body.clientHeight;
	...
	function Bubble(obj) {
		...
		var a = oBox.appendChild(document.createElement("a"));

		if (obj.photo){
			a.className = 'bub-link-photo';
			a.style.backgroundImage = 'url(' + obj.photo + ')';
		} else {
			a.className = 'bub-link';
